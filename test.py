...
def set_anchored_text(mse,r2,frameon=True,loc='upper left'):
    at = AnchoredText('MAE: %.5f\n$r^{2}$: %.5f' % (mse,r2), loc=loc, frameon=frameon,prop=dict(fontsize=7))
...
DIR = "outputs/9-elem-50-plastic_sbvf/val/"
...
for i,file in enumerate(file_list):
    ...
    ax1.add_artist(set_anchored_text(mse_x,r2_x))
    ...
    ax2.add_artist(set_anchored_text(mse_y,r2_y))
    ...
    ax3.add_artist(set_anchored_text(mse_xy,r2_xy))
